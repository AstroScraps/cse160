...
class Vector3 {
    ...
    add(other) {
        ...
        // surely all our vectors are 3d right :)
        // x
    ...
    static dot(other1, other2) {
        ...
        // calculate dot
        d = d + (other1.elements[0] * other2.elements[0]);
        d = d + (other1.elements[1] * other2.elements[1]);
        d = d + (other1.elements[2] * other2.elements[2]);
        // Don't delete the return statement.
        return d;
    }
    ...
    magnitude() {
        ...
        // calc the squares and sum them
        m = m + (this.elements[0] * this.elements[0])
        m = m + (this.elements[1] * this.elements[1])
        m = m + (this.elements[2] * this.elements[2])
        // square root it
        m = Math.sqrt(m);
        // Don't delete the return statement.
        return m;
